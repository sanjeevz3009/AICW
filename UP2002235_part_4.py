...
class MultiLayerNN(object):
    ...
    def feed_forward(self, x: npt.NDArray) -> npt.NDArray:
        ...
        # Second Hidden Layer
        # self.hidden2_input: Computes the weighted sum of the first hidden layer's output by the weights self.weight_hidden1_hidden2 and adds the bias self.bias_hidden2
        ...
        # Output Layer
        # self.output_input: Computes the weighted sum of the second hidden layer's output by the weights self.weight_hidden2_output and adds the bias self.bias_output
